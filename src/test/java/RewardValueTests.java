...
public class RewardValueTests {
    ...
    void create_with_miles_value() {
        ...
        double expectedMilesValue = milesValue;
    ...
    void convert_from_cash_to_miles() {
        ...
        // Calculate expected miles value based on the conversion rate
        double expectedMilesValue = cashValue * 0.0035;

        // Perform the conversion and check if the result is within a small delta
        assertEquals(expectedMilesValue, rewardValue.getMilesValue(), 0.001);
    }
    ...
    void convert_from_miles_to_cash() {
        ...
        // Calculate expected cash value based on the conversion rate
